...
// Floating click-to-chat button. For Indian student admissions WhatsApp
// converts far better than email, so it stays visible site-wide.
export default function WhatsAppButton({ number }: { number?: string }) {
  if (!number) return null;
  const href = whatsappLink(
    number,
    "Hi, I'd like to know more about admissions at ABS Educational Solution.",
  );
  return (
    <a
      href={href}
