        ...
        <nav className="hidden items-center gap-5 md:flex">
          ...
          {phone && (
            <a
              ...
              className="rounded-lg border border-brand px-4 py-2 text-sm font-semibold text-brand transition hover:bg-brand-light"
            >
              {phone}
            </a>
          )}
      ...
      {open && (
        <nav className="border-t border-gray-100 bg-white px-4 py-3 md:hidden">
          ...
          {phone && (
            <a
              href={`tel:${phone.replace(/\s/g, "")}`}
              className="mt-2 block rounded-lg border border-brand px-4 py-2 text-center text-sm font-semibold text-brand"
            >
              {phone}
            </a>
          )}
